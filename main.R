...
write.csv(df,"Persons.csv")
print(df)

#See the top rows of the data
#TASK: Write the function to see the top rows of the data
print("print  five Top  rows")
...
#and give it a name
p <- read.csv("Persons.csv")
df <- data.frame(Hair = c(p %>% select(Hair)),Sex= c(p %>% select(Sex)))
